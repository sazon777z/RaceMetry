...
// Внешний адресный RGB светодиод WS2812B (GPIO 10)
#define PIN_WS2812              10  // Внешний адресный светодиод WS2812B на GPIO 10
#define NUM_WS2812_LEDS         1

// Единственная аппаратная кнопка управления и питания на корпусе (GPIO 11 к GND)
#define PIN_BTN                 11      // Кнопка на корпусе -> GPIO 11 (к GND)
#define BTN_HOLD_POWER_OFF_MS   1800    // Длительное удержание для выключения (1.8 сек)
